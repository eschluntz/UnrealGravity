...
public void setup()
{
  ...
  //color controls
  RadioButton h = controlP5.addRadio("radioh",75,20);
    h.add("RED",0);
    h.add("GREEN",1);
    h.add("BLUE",2); 
    h.activate("BLUE");
  RadioButton l = controlP5.addRadio("radiol",125,20);
    l.add("RED",0);
    l.add("GREEN",1);
    l.add("BLUE",2);
    l.activate("GREEN");
...
//    }
  ...
  { 
    ...
    high = 255;
    low = PApplet.parseInt(random(255));
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "gravity_sim" });
  }
}
